...
class SalesOrderHeader(models.Model):
    ...
    purchase_order_header_id = models.PositiveIntegerField(
        null=True,
        blank=True,
    )
...
class SalesOrderLine(models.Model):
    ...
    sales_order_header_id = models.ForeignKey(
        SalesOrderHeader,
    ...
    purchase_order_line_id = models.PositiveIntegerField(
        null=True,
        blank=True,
    )
    order_number = models.CharField(
    ...
    def __str__(self):
        return '{s.line_id} lineID of {s.sales_order_header_id} headerID'.format(s=self)
