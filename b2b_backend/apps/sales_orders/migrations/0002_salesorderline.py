# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-06-25 13:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edi_id', models.CharField(blank=True, help_text='Electronic Data Exchange Between Two Tables', max_length=60, null=True, verbose_name='EDI ID')),
                ...
                ('purchase_order_header_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='purchase_orders.PurchaseOrderHeader')),
                ('purchase_order_line_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='purchase_orders.PurchaseOrderLine')),
                ('sales_order_header_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales_orders.SalesOrderHeader')),
            ],
        ),
    ]
