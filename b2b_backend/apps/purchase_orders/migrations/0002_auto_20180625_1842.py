# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-06-25 13:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='edi_id',
            field=models.CharField(blank=True, help_text='Electronic Data Exchange Between Two Tables', max_length=60, null=True, verbose_name='EDI ID'),
        ),
        migrations.AddField(
            model_name='purchaseorderline',
            name='purchase_order_header_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='purchase_orders.PurchaseOrderHeader'),
        ),
    ]
